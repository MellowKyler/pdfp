...
from PySide6.QtGui import QCloseEvent, Qt, QWheelEvent
...
class SettingsWindow(QWidget):
    ...
    def __init__(self) -> None:
        ...
        gen_grid.addWidget(gen_settings_label, 0, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter)
        gen_grid.addWidget(self.add_file_checkbox, 1, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter)
        gen_grid.addWidget(self.remember_window_checkbox, 2, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        f2p_grid.addWidget(f2p_settings_label, 0, 0, alignment=Qt.AlignmentFlag.AlignCenter)
        f2p_grid.addWidget(self.f2p_cover_checkbox, 1, 0, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        png_grid.addWidget(png_settings_label, 0, 0, alignment=Qt.AlignmentFlag.AlignCenter)
        png_grid.addWidget(self.png_cover_checkbox, 1, 0, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        ocr_grid.addWidget(ocr_settings_label, 0, 0, 1, 3, alignment=Qt.AlignmentFlag.AlignCenter)
        ocr_grid.addWidget(ocr_radio_label, 1, 0, alignment=Qt.AlignmentFlag.AlignRight)
        ocr_grid.addWidget(self.ocr_pdf_radio, 1, 1, alignment=Qt.AlignmentFlag.AlignLeft)
        ocr_grid.addWidget(self.ocr_pdfa_radio, 1, 2, alignment=Qt.AlignmentFlag.AlignLeft)
        ocr_grid.addWidget(ocr_optimize_label, 2, 0, alignment=Qt.AlignmentFlag.AlignRight)
        ocr_grid.addWidget(self.ocr_optimize_level, 2, 1, alignment=Qt.AlignmentFlag.AlignLeft)
        ocr_grid.addWidget(self.ocr_deskew_checkbox, 3, 0, 1, 3, alignment=Qt.AlignmentFlag.AlignCenter)
        ocr_grid.addWidget(self.native_ocr_checkbox, 4, 0, 1, 3, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        crop_grid.addWidget(crop_settings_label, 0, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter)
        crop_grid.addWidget(self.auto_crop_radio, 1, 0, alignment=Qt.AlignmentFlag.AlignRight)
        crop_grid.addWidget(self.launch_briss_radio, 1, 1, alignment=Qt.AlignmentFlag.AlignLeft)
        ...
        main_fn_grid.addWidget(filename_settings_label, 0, 0, 1, 3, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        main_fn_grid.addWidget(self.first_word_filename_checkbox, 3, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter)
        main_fn_grid.addWidget(self.lowercase_filename_checkbox, 3, 2, alignment=Qt.AlignmentFlag.AlignCenter)
        main_fn_grid.addWidget(self.prevent_overwrite_checkbox, 4, 0, 1, 3, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        enable_pgnum_layout.setAlignment(Qt.AlignmentFlag.AlignCenter)

        pgnum_box_label = QLabel("<strong>Page Number Options:<strong>")
        pgnum_box_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        enable_ps_layout.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        ps_grid = QGridLayout()
        ps_grid.addWidget(ps_box_label, 0, 0, 1, 4, alignment=Qt.AlignmentFlag.AlignCenter)
        ps_grid.addWidget(self.prefix_radio, 1, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignRight)
        ps_grid.addWidget(self.suffix_radio, 1, 2, 1, 2, alignment=Qt.AlignmentFlag.AlignLeft)
        ps_grid.addWidget(char_ps_label, 2, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignRight)
        ps_grid.addWidget(self.char_ps_input, 2, 2, 1, 2, alignment=Qt.AlignmentFlag.AlignLeft)
        ...
        ps_grid.addWidget(self.disable_non_pdf_ps_checkbox, 7, 0, 1, 4, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        log_grid.addWidget(logging_settings_label, 0, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter)
        log_grid.addWidget(log_level_label, 1, 0, alignment=Qt.AlignmentFlag.AlignRight)
        log_grid.addWidget(self.log_level_combobox, 1, 1, alignment=Qt.AlignmentFlag.AlignLeft)
        log_grid.addWidget(self.log_file_checkbox, 2, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter)
        log_grid.addWidget(self.log_file_radio, 3, 0, alignment=Qt.AlignmentFlag.AlignRight)
        log_grid.addWidget(self.json_file_radio, 3, 1, alignment=Qt.AlignmentFlag.AlignLeft)
        log_grid.addWidget(restart_logger_button, 4, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        self.button_box.addButton(load_preset_button, QDialogButtonBox.ButtonRole.ActionRole)
        self.button_box.addButton(save_preset_button, QDialogButtonBox.ButtonRole.ActionRole)
    ...
    def save_as_settings(self) -> None:
        """Save current settings configuration to an INI file."""
        save_filename = self.save_ini_file()
        self.ini_file = QSettings(save_filename, QSettings.Format.IniFormat)
        self.save_settings(True, self.ini_file)

    def load_as_settings(self) -> None:
    ...
    def load_settings(self, remain_open: bool = False, ini_file: QSettings | None = None) -> None:
        """
        ...
        get_value = self.settings.value if ini_file is None else ini_file.value
        ...
        # filename
        self.default_filename_checkbox.setChecked(
    ...
    def save_settings(self, remain_open: bool = False, ini_file: QSettings | None = None) -> None:
        """
        ...
        """
        set_value = self.settings.setValue if ini_file is None else ini_file.setValue
    ...
    def populate_settings(self) -> None:
        ...
        try:
            ...
            try:
                pathlib.Path(ini_file_path).unlink()
                logger.info("Corrupt settings file deleted.")
            except OSError as e:
                logger.error("Error deleting corrupt settings file: %s", e)
            logger.info("Resetting settings...")
            self.reset_settings()
        self.save_settings()

    def log_file_checkbox_action(self, checked: bool) -> None:
        """
    ...
    def restart_logger_action(self) -> None:
    ...
    def default_filename_checkbox_action(self, checked: bool) -> None:
        """
    ...
    def filler_char_checkbox_action(self, checked: bool) -> None:
        """
    ...
    def prefix_suffix_checkbox_action(self, checked: bool) -> None:
        """
    ...
    def pgnum_enable_action(self) -> None:
        """
    ...
    def pgnum_prefix_checkbox_action(self, checked: bool) -> None:
        """
    ...
    def pgnum_wrap_checkbox_action(self, checked: bool) -> None:
        """
    ...
    def select_briss_file(self) -> None:
    ...
    def select_file(self, filetype: str = "") -> str | None:
        """
    ...
    def get_config_dir(self) -> str:
        ...
        if not pathlib.Path(config_directory).is_dir():
            pathlib.Path(config_directory).mkdir()
        return config_directory

    def save_ini_file(self) -> str:
        """Open a file dialog to select or create an INI file and return its path."""
        config_directory = self.get_config_dir()
        file_path, _ = QFileDialog.getSaveFileName(
            self, "Select or Create INI File", config_directory, "INI Files (*.ini);;All Files (*)"
        )
        if file_path and not file_path.endswith(".ini"):
            file_path += ".ini"
        return file_path
